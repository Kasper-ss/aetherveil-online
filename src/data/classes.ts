...
export const RESOURCES: Record<ResourceId, Resource> = {
  ...
  stone_chunk: { id: 'stone_chunk', name: 'Stone Chunk', nameRu: 'Каменный блок', icon: '🪨' },
  gold_ore: { id: 'gold_ore', name: 'Gold Ore', nameRu: 'Золотая руда', icon: '🥇' },
  raw_diamond: { id: 'raw_diamond', name: 'Raw Diamond', nameRu: 'Необработанный алмаз', icon: '💎' },
  mithril_ore: { id: 'mithril_ore', name: 'Mithril Ore', nameRu: 'Мифриловая руда', icon: '⚙️' },
  adamantite: { id: 'adamantite', name: 'Adamantite', nameRu: 'Адамантий', icon: '🛡️' },
  sulfur: { id: 'sulfur', name: 'Sulfur', nameRu: 'Сера', icon: '🟡' },
  rare_spice: { id: 'rare_spice', name: 'Rare Spice', nameRu: 'Редкие специи', icon: '🧂' },
  abyssal_pearl: { id: 'abyssal_pearl', name: 'Abyssal Pearl', nameRu: 'Жемчуг бездны', icon: '🔵' },
  fish_minnow: { id: 'fish_minnow', name: 'Minnow', nameRu: 'Пескарь', icon: '🐟' },
  fish_bream: { id: 'fish_bream', name: 'Bream', nameRu: 'Лещ', icon: '🐟' },
  fish_carp: { id: 'fish_carp', name: 'Carp', nameRu: 'Карп', icon: '🐟' },
  fish_perch: { id: 'fish_perch', name: 'Perch', nameRu: 'Окунь', icon: '🐟' },
  fish_trout: { id: 'fish_trout', name: 'Trout', nameRu: 'Форель', icon: '🐟' },
  fish_salmon: { id: 'fish_salmon', name: 'Salmon', nameRu: 'Лосось', icon: '🐟' },
  fish_pike: { id: 'fish_pike', name: 'Pike', nameRu: 'Щука', icon: '🐟' },
  fish_tuna: { id: 'fish_tuna', name: 'Tuna', nameRu: 'Тунец', icon: '🐟' },
  fish_cod: { id: 'fish_cod', name: 'Cod', nameRu: 'Треска', icon: '🐟' },
  fish_eel: { id: 'fish_eel', name: 'Eel', nameRu: 'Угорь', icon: '🐍' },
  fish_crab: { id: 'fish_crab', name: 'Crab', nameRu: 'Краб', icon: '🦀' },
  fish_lobster: { id: 'fish_lobster', name: 'Lobster', nameRu: 'Омар', icon: '🦞' },
  fish_squid: { id: 'fish_squid', name: 'Squid', nameRu: 'Кальмар', icon: '🦑' },
  ...
  aura_ore: { id: 'aura_ore', name: 'Aura Ore', nameRu: 'Aura-руда', icon: '✨' },
  goodnes_ore: { id: 'goodnes_ore', name: 'Goodnes Ore', nameRu: 'Goodnes-руда', icon: '🌟' },
