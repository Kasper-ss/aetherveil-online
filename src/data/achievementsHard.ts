...
export const ACHIEVEMENTS_HARD: AchievementDef[] = [
  ...
  { id: 'hard_hunt_800', nameRu: 'Охотник элиты', descriptionRu: 'Набрать 800 XP охоты.', icon: '🏹', tier: 'gold', rewardPreviewRu: '1 500 🪙', reward: { gold: 1500, resources: { meat: 20, bone: 15 } }, check: (p) => professionXp(p, 'huntXp') >= 800, progress: (p) => ({ current: professionXp(p, 'huntXp'), target: 800 }) },
